...
class TransaksiController extends Controller
{
    ...
    public function laporan(Request $request)
    {
        ...
        $totalDenda = $transaksis->sum('denda_total');
        
        return view('transaksi.laporan', compact('transaksis', 'anggotas', 'totalDenda'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('transaksi.pdf', compact('transaksis', 'totalDenda'));
    ...
    {
        $hariTerlambat = $transaksi->tanggal_kembali->startOfDay()->diffInDays($tanggalDikembalikan->startOfDay(), false);
